...
import java.io.ObjectInputStream;
  ...
  public class EncriptaDecriptaRSA {
    ...
    public static final String PATH_CHAVE_PRIVADA = getLocal()+"/keys/private.key";
   
    /**
     * Local da chave pública no sistema de arquivos.
     */
    public static final String PATH_CHAVE_PUBLICA = getLocal()+"/keys/public.key";
   
    /**
     * Gera a chave que contém um par de chave Privada e Pública usando 512 bytes.
     ...
     */
    /**
     * was Criptografa o texto puro usando chave privada.
     */
    ...
    public static void main(String[] args) {
      ...
      try {
        ...
        final String msgOriginal = "qWilson é Legal";

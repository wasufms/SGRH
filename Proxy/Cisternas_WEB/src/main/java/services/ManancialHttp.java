...
public class ManancialHttp {
	...
	public static void main(String[] args) {
		...
		//Manancial manancial=manancialHttp.getManancial("1");
		//manancial.setOutro("Teste alterar");
		//System.out.println(manancial.toString());
		//manancialHttp.salvarManancial(manancial);
		//System.out.println(manancial.toString());
		/*Manancial manancial2=new Manancial();
		manancial2.setId("2");
		manancial2.setNome("manancia do Rio Seco");
		manancial.setPosition("-8.100651, -35.017939");
		manancialHttp.salvarManancial(manancial2);*/
		List<Manancial>manancials=new ArrayList<Manancial>();
		manancials=manancialHttp.getManancials();
		for (Manancial manancial2 : manancials) {
			System.out.println(manancial2);
		}
	}
